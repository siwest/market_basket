...
def apriori(orders, support_threshold):
    ...
    one_item_candidate_set = generate_candidate_set(
        orders, inventory_list, support_threshold)
    ...
    while(k < N):
        ...
        k_item_candidate_set = generate_candidate_set(
            orders, k_item_set, support_threshold)
        k = k+1
    pass
